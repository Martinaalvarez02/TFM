...
from imblearn.over_sampling import RandomOverSampler  # <- CAMBIO aquí
...
# --- Ver distribución de clases antes del oversampling ---
print("\nDistribución de clases en el conjunto de entrenamiento antes del oversampling:")
print(pd.Series(y_train).value_counts())

# --- Aplicar Random Oversampling ---
print("Aplicando RandomOverSampler para balancear clases...")
ros = RandomOverSampler(random_state=42)
X_train_res, y_train_res = ros.fit_resample(X_train, y_train)

# --- Ver distribución de clases después del oversampling ---
